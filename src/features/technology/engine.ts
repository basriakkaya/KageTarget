...
export const TECHNOLOGY_SIGNATURES: TechnologySignature[] = [
  ...
  {id:"next",name:"Next.js",category:"Web Framework",strong:true,rules:[{source:"resource",pattern:/\/_next\/static\//i,weight:4,label:"/_next/static/ asset"},{source:"marker",pattern:/__NEXT_DATA__/i,weight:5,label:"__NEXT_DATA__ marker"}]},
  ...
  {id:"vue",name:"Vue",category:"JavaScript Framework",rules:[{source:"resource",pattern:/(?:vue(?:\.runtime)?(?:\.global)?|vue-router)[.-](?:min\.)?js/i,weight:3,label:"Vue script"},{source:"marker",pattern:/data-v-[\da-f]+/i,weight:3,label:"Vue scoped marker"}]},
